...
public class Call {
    ...
    public void onCallTsxState(OnCallTsxStateParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallTsxState(swigCPtr, this, OnCallTsxStateParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallTsxStateSwigExplicitCall(swigCPtr, this, OnCallTsxStateParam.getCPtr(prm), prm);
    }

    public void onCallMediaState(OnCallMediaStateParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallMediaState(swigCPtr, this, OnCallMediaStateParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallMediaStateSwigExplicitCall(swigCPtr, this, OnCallMediaStateParam.getCPtr(prm), prm);
    }

    public void onCallSdpCreated(OnCallSdpCreatedParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallSdpCreated(swigCPtr, this, OnCallSdpCreatedParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallSdpCreatedSwigExplicitCall(swigCPtr, this, OnCallSdpCreatedParam.getCPtr(prm), prm);
    }

    public void onStreamCreated(OnStreamCreatedParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onStreamCreated(swigCPtr, this, OnStreamCreatedParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onStreamCreatedSwigExplicitCall(swigCPtr, this, OnStreamCreatedParam.getCPtr(prm), prm);
    }

    public void onStreamDestroyed(OnStreamDestroyedParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onStreamDestroyed(swigCPtr, this, OnStreamDestroyedParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onStreamDestroyedSwigExplicitCall(swigCPtr, this, OnStreamDestroyedParam.getCPtr(prm), prm);
    }

    public void onDtmfDigit(OnDtmfDigitParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onDtmfDigit(swigCPtr, this, OnDtmfDigitParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onDtmfDigitSwigExplicitCall(swigCPtr, this, OnDtmfDigitParam.getCPtr(prm), prm);
    }

    public void onCallTransferRequest(OnCallTransferRequestParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallTransferRequest(swigCPtr, this, OnCallTransferRequestParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallTransferRequestSwigExplicitCall(swigCPtr, this, OnCallTransferRequestParam.getCPtr(prm), prm);
    }

    public void onCallTransferStatus(OnCallTransferStatusParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallTransferStatus(swigCPtr, this, OnCallTransferStatusParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallTransferStatusSwigExplicitCall(swigCPtr, this, OnCallTransferStatusParam.getCPtr(prm), prm);
    }

    public void onCallReplaceRequest(OnCallReplaceRequestParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallReplaceRequest(swigCPtr, this, OnCallReplaceRequestParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallReplaceRequestSwigExplicitCall(swigCPtr, this, OnCallReplaceRequestParam.getCPtr(prm), prm);
    }

    public void onCallReplaced(OnCallReplacedParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallReplaced(swigCPtr, this, OnCallReplacedParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallReplacedSwigExplicitCall(swigCPtr, this, OnCallReplacedParam.getCPtr(prm), prm);
    }

    public void onCallRxOffer(OnCallRxOfferParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallRxOffer(swigCPtr, this, OnCallRxOfferParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallRxOfferSwigExplicitCall(swigCPtr, this, OnCallRxOfferParam.getCPtr(prm), prm);
    }

    public void onCallTxOffer(OnCallTxOfferParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallTxOffer(swigCPtr, this, OnCallTxOfferParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallTxOfferSwigExplicitCall(swigCPtr, this, OnCallTxOfferParam.getCPtr(prm), prm);
    }

    public void onInstantMessage(OnInstantMessageParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onInstantMessage(swigCPtr, this, OnInstantMessageParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onInstantMessageSwigExplicitCall(swigCPtr, this, OnInstantMessageParam.getCPtr(prm), prm);
    }

    public void onInstantMessageStatus(OnInstantMessageStatusParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onInstantMessageStatus(swigCPtr, this, OnInstantMessageStatusParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onInstantMessageStatusSwigExplicitCall(swigCPtr, this, OnInstantMessageStatusParam.getCPtr(prm), prm);
    }

    public void onTypingIndication(OnTypingIndicationParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onTypingIndication(swigCPtr, this, OnTypingIndicationParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onTypingIndicationSwigExplicitCall(swigCPtr, this, OnTypingIndicationParam.getCPtr(prm), prm);
    }
    ...
    public void onCallMediaTransportState(OnCallMediaTransportStateParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallMediaTransportState(swigCPtr, this, OnCallMediaTransportStateParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallMediaTransportStateSwigExplicitCall(swigCPtr, this, OnCallMediaTransportStateParam.getCPtr(prm), prm);
    }

    public void onCallMediaEvent(OnCallMediaEventParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCallMediaEvent(swigCPtr, this, OnCallMediaEventParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCallMediaEventSwigExplicitCall(swigCPtr, this, OnCallMediaEventParam.getCPtr(prm), prm);
    }

    public void onCreateMediaTransport(OnCreateMediaTransportParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCreateMediaTransport(swigCPtr, this, OnCreateMediaTransportParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCreateMediaTransportSwigExplicitCall(swigCPtr, this, OnCreateMediaTransportParam.getCPtr(prm), prm);
    }

    public void onCreateMediaTransportSrtp(OnCreateMediaTransportSrtpParam prm) {
        if (getClass() == Call.class)
            pjsua2JNI.Call_onCreateMediaTransportSrtp(swigCPtr, this, OnCreateMediaTransportSrtpParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Call_onCreateMediaTransportSrtpSwigExplicitCall(swigCPtr, this, OnCreateMediaTransportSrtpParam.getCPtr(prm), prm);
    }
